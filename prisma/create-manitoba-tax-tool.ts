// One-time (but safe to re-run) setup script: creates the Manitoba Income Tax
...
// `canadaCustomCalculators["manitoba-income-tax-calculator"]` in src/lib/calc-engine-canada.ts.
//
// HOW TO RUN
//   npx tsx prisma/create-manitoba-tax-tool.ts
// or
//   npm run db:create-manitoba-tool
...
const SLUG = "manitoba-income-tax-calculator";

const content: CanadaProvinceContent = {
  slug: SLUG,
  name: "Manitoba",
  adjective: "Manitoba's",
  bracketDescription:
    "10.8% up to $47,000, 12.75% up to $100,000, and 17.4% above that",
  bpa: 15780,
  lowestRatePercent: "10.8%",
  baseline: {
    grossMonthly: 5000.0,
    federalTaxMonthly: 516.06,
    provincialTaxMonthly: 419.11,
    payrollLabel: "CPP",
    payrollMonthly: 280.15,
    eiMonthly: 81.5,
    totalDeductionsMonthly: 1296.81,
    netMonthly: 3703.19,
    annualNet: 44438.26,
  },
};
